...
// Shift linked code by five 64-byte instruction-cache sets. This established
// public redraw vehicle is data-only and is never read by the prover.
#[used]
static POINTS_LAYOUT_ROLL_320: [u8; 320] = [0u8; 320];
