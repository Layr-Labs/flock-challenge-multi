...
fn witgen_urm_share_enabled() -> bool {
    ...
    // the polarity pair on this lineage (`67937882` local vs `ffd0c34`
    // shared, adjacent official draws) read +0.41% for the shared arm, and
    // the base lineage ships the shared table.
