...
// Yukon exact-content redraw marker: correction-plus-PEXT draw 2.
// Yukon exact-content redraw marker: correction-plus-PEXT draw 3.
// Yukon exact-content redraw marker: correction-plus-PEXT draw 4.

// Yukon archive redraw marker: public PEXT composition, draw 2.
// Yukon archive redraw marker: public PEXT composition, draw 3.
