...
pub(super) unsafe fn butterfly_fused_2layer_row_from_sparse_dense_geo(
    ...
    // SAFETY: `inner_low` and `outer_low` prove the corresponding low-limb
    // preconditions by inspecting the actual twiddles.
    unsafe {
        match (outer_low, diet_disabled, inner_low) {
            (true, false, false) => butterfly_fused_2layer_row_from_sparse_dense_geo_impl::<
                true,
                true,
                false,
            >(
                src, src_quarter, src_r, dst_sparse, dst_dense, dst_quarter, num_ntts, right_twiddle,
                dense_tw, pf_src,
            ),
            (true, false, true) => butterfly_fused_2layer_row_from_sparse_dense_geo_impl::<
                true,
                true,
                true,
            >(
            ...
            (false, true, false) => butterfly_fused_2layer_row_from_sparse_dense_geo_impl::<
                false,
                false,
                false,
            >(
            ...
            (false, true, true) => butterfly_fused_2layer_row_from_sparse_dense_geo_impl::<
                false,
                false,
                true,
            >(
            ...
            (false, false, false) => butterfly_fused_2layer_row_from_sparse_dense_geo_impl::<
                false,
                true,
                false,
            >(
            ...
            (false, false, true) => butterfly_fused_2layer_row_from_sparse_dense_geo_impl::<
                false,
                true,
                true,
            >(
            ...
            (true, true, _) => core::hint::unreachable_unchecked(),
        }
    }
}
