...
pub(super) unsafe fn butterfly_fused_2layer_row_from_geo(
    ...
    unsafe {
        ...
        match (diet_disabled, outer_low, inner_low) {
            ...
            (false, false, false) => {
                butterfly_fused_2layer_row_from_geo_impl::<false, true, false, false>(
                    src, src_quarter, src_r, dst, dst_quarter, dst_r, num_ntts, twiddles,
                )
            }
            (false, false, true) => {
                butterfly_fused_2layer_row_from_geo_impl::<false, true, false, true>(
                    src, src_quarter, src_r, dst, dst_quarter, dst_r, num_ntts, twiddles,
                )
            }
            (false, true, false) => {
                butterfly_fused_2layer_row_from_geo_impl::<true, true, false, false>(
                    src, src_quarter, src_r, dst, dst_quarter, dst_r, num_ntts, twiddles,
                )
            }
            (false, true, true) => {
                butterfly_fused_2layer_row_from_geo_impl::<true, true, false, true>(
                    src, src_quarter, src_r, dst, dst_quarter, dst_r, num_ntts, twiddles,
                )
            }
        }
...
pub(super) unsafe fn butterfly_fused_2layer_row_from_geo_nt(
    ...
    unsafe {
        ...
        match (diet_disabled, outer_low, inner_low) {
            ...
            (false, false, false) => {
                butterfly_fused_2layer_row_from_geo_impl::<false, true, true, false>(
                    src, src_quarter, src_r, dst, dst_quarter, dst_r, num_ntts, twiddles,
                )
            }
            (false, false, true) => {
                butterfly_fused_2layer_row_from_geo_impl::<false, true, true, true>(
                    src, src_quarter, src_r, dst, dst_quarter, dst_r, num_ntts, twiddles,
                )
            }
            (false, true, false) => {
                butterfly_fused_2layer_row_from_geo_impl::<true, true, true, false>(
                    src, src_quarter, src_r, dst, dst_quarter, dst_r, num_ntts, twiddles,
                )
            }
            (false, true, true) => {
                butterfly_fused_2layer_row_from_geo_impl::<true, true, true, true>(
                    src, src_quarter, src_r, dst, dst_quarter, dst_r, num_ntts, twiddles,
                )
            }
        }
...
pub(super) unsafe fn butterfly_fused_2layer_row_from_sparse_geo(
    ...
    unsafe {
        ...
        if mul_diet_disabled() {
            if inner_low {
                butterfly_fused_2layer_row_from_sparse_geo_impl::<false, false, false, true>(
                    src,
                    src_quarter,
                    src_r,
                    dst,
            ...
            if inner_low {
                butterfly_fused_2layer_row_from_sparse_geo_impl::<true, false, false, true>(
                    src,
                    src_quarter,
                    src_r,
                    dst,
...
pub(super) unsafe fn butterfly_fused_2layer_row_from_sparse_geo_pf(
    ...
    unsafe {
        ...
        if mul_diet_disabled() {
            if inner_low {
                butterfly_fused_2layer_row_from_sparse_geo_impl::<false, true, false, true>(
                    src,
                    src_quarter,
                    src_r,
                    dst,
            ...
            if inner_low {
                butterfly_fused_2layer_row_from_sparse_geo_impl::<true, true, false, true>(
                    src,
                    src_quarter,
                    src_r,
                    dst,
...
pub(super) unsafe fn butterfly_fused_2layer_row_from_sparse_dense_geo(
    ...
    unsafe {
        ...
        match (diet_disabled, outer_low, inner_low) {
            (true, _, _) => {
                butterfly_fused_2layer_row_from_sparse_dense_geo_impl::<false, false, false>(
                    src,
                    src_quarter,
                    src_r,
                    dst_sparse,
            ...
            (false, false, true) => {
                butterfly_fused_2layer_row_from_sparse_dense_geo_impl::<false, true, true>(
                    src,
                    src_quarter,
                    src_r,
                    dst_sparse,
            ...
            (false, true, true) => {
                butterfly_fused_2layer_row_from_sparse_dense_geo_impl::<true, true, true>(
                    src,
                    src_quarter,
                    src_r,
                    dst_sparse,
...
>(
    ...
    unsafe {
        debug_assert!(!OUTER_LOW || t_outer.hi == 0);
        debug_assert!(!INNER_LOW || (right_twiddle.hi == 0 && t_inner_a.hi == 0 && t_inner_b.hi == 0));
