...
unsafe fn butterfly_row_pair_impl<const LOW: bool, const DIET: bool>(
    ...
    unsafe {
        ...
        while i + 8 <= lanes {
            ...
            let prod0 = mul_x4::<LOW, DIET>(tw, bot0);
            let prod1 = mul_x4::<LOW, DIET>(tw, bot1);

            let new_top0 = _mm512_xor_si512(top0, prod0);
            let new_top1 = _mm512_xor_si512(top1, prod1);
...
>(
    ...
    unsafe {
        ...
        while i + 8 <= lanes {
            ...
            // Layer 1
            let prod_c0 = mul_x4::<OUTER_LOW, DIET>(outer, vc0);
            let prod_c1 = mul_x4::<OUTER_LOW, DIET>(outer, vc1);
            let prod_d0 = mul_x4::<OUTER_LOW, DIET>(outer, vd0);
            let prod_d1 = mul_x4::<OUTER_LOW, DIET>(outer, vd1);

            let new_a0 = _mm512_xor_si512(va0, prod_c0);
            let new_a1 = _mm512_xor_si512(va1, prod_c1);
            vc0 = _mm512_xor_si512(vc0, new_a0);
            vc1 = _mm512_xor_si512(vc1, new_a1);
            va0 = new_a0;
            va1 = new_a1;

            let new_b0 = _mm512_xor_si512(vb0, prod_d0);
            let new_b1 = _mm512_xor_si512(vb1, prod_d1);
            ...
            // Layer 2
            let prod_b0 = mul_x4::<INNER_LOW, DIET>(inner_a, vb0);
            let prod_b1 = mul_x4::<INNER_LOW, DIET>(inner_a, vb1);
            let prod_d0_2 = mul_x4::<INNER_LOW, DIET>(inner_b, vd0);
            let prod_d1_2 = mul_x4::<INNER_LOW, DIET>(inner_b, vd1);

            let new_a0 = _mm512_xor_si512(va0, prod_b0);
            let new_a1 = _mm512_xor_si512(va1, prod_b1);
            vb0 = _mm512_xor_si512(vb0, new_a0);
            vb1 = _mm512_xor_si512(vb1, new_a1);
            va0 = new_a0;
            va1 = new_a1;

            let new_c0 = _mm512_xor_si512(vc0, prod_d0_2);
            let new_c1 = _mm512_xor_si512(vc1, prod_d1_2);
...
>(
    ...
    unsafe {
        ...
        while lane + 8 <= lanes {
            ...
            // Layer 2
            let prod_b0 = mul_x4::<false, DIET>(inner_a, vb0);
            let prod_b1 = mul_x4::<false, DIET>(inner_a, vb1);
            let prod_d0_2 = mul_x4::<false, DIET>(inner_b, vd0);
            let prod_d1_2 = mul_x4::<false, DIET>(inner_b, vd1);
        ...
        while lane + 8 <= lanes {
            if PF {
                ...
                for i in 0..4 {
                    ...
                    _mm_prefetch::<_MM_HINT_T0>(pf_row(i).add(off + 4 * core::mem::size_of::<F128>()));
                }
            }
            ...
            let prod_d0 = mul_x4::<INNER_LOW, DIET>(inner_b, vd0);
            let prod_d1 = mul_x4::<INNER_LOW, DIET>(inner_b, vd1);

            let new_c0 = _mm512_xor_si512(vc0, prod_d0);
            let new_c1 = _mm512_xor_si512(vc1, prod_d1);
            vd0 = _mm512_xor_si512(vd0, new_c0);
            vd1 = _mm512_xor_si512(vd1, new_c1);
            vc0 = new_c0;
            vc1 = new_c1;
...
>(
    ...
    unsafe {
        ...
        while lane + 8 <= lanes {
            ...
            let prod_sd0 = mul_x4::<false, DIET>(sparse_b, sd0);
            let prod_sd1 = mul_x4::<false, DIET>(sparse_b, sd1);

            let new_sc0 = _mm512_xor_si512(sc0, prod_sd0);
            let new_sc1 = _mm512_xor_si512(sc1, prod_sd1);
            ...
            // Dense path: Layer 1
            let prod_vc0 = mul_x4::<OUTER_LOW, DIET>(outer, vc0);
            let prod_vc1 = mul_x4::<OUTER_LOW, DIET>(outer, vc1);
            let prod_vd0 = mul_x4::<OUTER_LOW, DIET>(outer, vd0);
            let prod_vd1 = mul_x4::<OUTER_LOW, DIET>(outer, vd1);

            let new_da0 = _mm512_xor_si512(va0, prod_vc0);
            let new_da1 = _mm512_xor_si512(va1, prod_vc1);
            let dvc0 = _mm512_xor_si512(vc0, new_da0);
            let dvc1 = _mm512_xor_si512(vc1, new_da1);
            let dva0 = new_da0;
            let dva1 = new_da1;

            let new_db0 = _mm512_xor_si512(vb0, prod_vd0);
            let new_db1 = _mm512_xor_si512(vb1, prod_vd1);
            let dvd0 = _mm512_xor_si512(vd0, new_db0);
            let dvd1 = _mm512_xor_si512(vd1, new_db1);
            let dvb0 = new_db0;
            let dvb1 = new_db1;

            // Dense path: Layer 2
            let prod_dvb0 = mul_x4::<false, DIET>(inner_a, dvb0);
            let prod_dvb1 = mul_x4::<false, DIET>(inner_a, dvb1);
            let prod_dvd0 = mul_x4::<false, DIET>(inner_b, dvd0);
            let prod_dvd1 = mul_x4::<false, DIET>(inner_b, dvd1);

            let new_da0_2 = _mm512_xor_si512(dva0, prod_dvb0);
            let new_da1_2 = _mm512_xor_si512(dva1, prod_dvb1);
            let dvb0 = _mm512_xor_si512(dvb0, new_da0_2);
            let dvb1 = _mm512_xor_si512(dvb1, new_da1_2);
            let dva0 = new_da0_2;
            let dva1 = new_da1_2;

            let new_dc0 = _mm512_xor_si512(dvc0, prod_dvd0);
            let new_dc1 = _mm512_xor_si512(dvc1, prod_dvd1);
            let dvd0 = _mm512_xor_si512(dvd0, new_dc0);
            let dvd1 = _mm512_xor_si512(dvd1, new_dc1);
            let dvc0 = new_dc0;
            let dvc1 = new_dc1;

            _mm512_storeu_si512(dn_row(0).add(lane) as *mut __m512i, dva0);
            _mm512_storeu_si512(dn_row(1).add(lane) as *mut __m512i, dvb0);
            _mm512_storeu_si512(dn_row(2).add(lane) as *mut __m512i, dvc0);
            _mm512_storeu_si512(dn_row(3).add(lane) as *mut __m512i, dvd0);

            _mm512_storeu_si512(dn_row(0).add(lane + 4) as *mut __m512i, dva1);
            _mm512_storeu_si512(dn_row(1).add(lane + 4) as *mut __m512i, dvb1);
            _mm512_storeu_si512(dn_row(2).add(lane + 4) as *mut __m512i, dvc1);
            _mm512_storeu_si512(dn_row(3).add(lane + 4) as *mut __m512i, dvd1);
