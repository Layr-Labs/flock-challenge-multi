...
fn ranked_open_induce_overlap_enabled(
    ...
    cfg!(all(
        ...
        // separate-phase schedule): this archive runs the overlap arm of the
        // pair experiment — its sibling archive runs separate phases — so the
        // two official draws isolate the schedule on this exact tree.
