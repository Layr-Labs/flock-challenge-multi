        ...
        .map_init(
            ...
            |(scratch, mid), (block, (b_out, f_out))| {
                ...
                if b_gfni_on {
                    ...
                    // Every plane is overwritten by the first map stage before
                    // the kernel reads it; avoid clearing this 1 KiB workspace.
                    let mut planes =
                        core::mem::MaybeUninit::<[__m512i; 16]>::uninit();
                    for slot in (0..block_len).step_by(64) {
                        ...
                        unsafe {
                            gfni_fold64_four_maps_staged(
                                ...
                                planes.as_mut_ptr().cast::<__m512i>(),
                            );
                        }
                    }
                }
