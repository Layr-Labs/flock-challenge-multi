...
/// Serial Montgomery batch inversion for the short denominator vectors used
/// by dense Ligerito basis induction. Zero inputs remain zero, matching the
/// previous element-wise inversion contract.
