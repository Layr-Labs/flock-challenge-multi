...
/// The ranked opening keeps row/Merkle collection and induced-basis
/// construction in separate phases.
#[inline(always)]
fn ranked_open_induce_overlap_enabled(
    _config: &ProverConfig,
    _log_n: usize,
    _direct_fold8_mode: bool,
) -> bool {
    false
}
...
/// Ranked selector for the retired chunk-local densification path.
#[inline(always)]
