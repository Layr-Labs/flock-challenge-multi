...
/// # Safety
///
/// The caller must provide the validated residual offset table and matching
/// table images, a writable 64-byte output buffer aligned for the selected
/// store, and a `keep` mask of `0xfc` or `0x0f`. The target-feature
/// requirements of the selected implementation must also be available.
#[inline(always)]
#[allow(unused_variables)]
