...
/// # Safety
///
/// As for [`round1_ab_inner_window_from_offsets_nt2`], with `plan.nt == 2`,
/// `out` 64-byte aligned, and `keep` equal to `0xfc` or `0x0f`. The producing
/// thread must execute [`abinner_publish_fence`] before publishing the output.
#[allow(unused_variables)]
