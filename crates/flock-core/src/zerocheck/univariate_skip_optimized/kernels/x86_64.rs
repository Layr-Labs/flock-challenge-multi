    ...
    unsafe {
        ...
        for k in (0..16).step_by(4) {
            ...
            if bm < N {
                ...
                acc2 = _mm512_xor_si512(acc2, _mm512_gf2p8affine_epi64_epi8::<0>(r, _mm512_set1_epi64(mats[bm * 16 + k + 2] as i64)));
                acc3 = _mm512_xor_si512(acc3, _mm512_gf2p8affine_epi64_epi8::<0>(r, _mm512_set1_epi64(mats[bm * 16 + k + 3] as i64)));
            }
