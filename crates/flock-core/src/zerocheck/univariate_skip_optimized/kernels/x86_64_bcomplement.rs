...
pub(crate) unsafe fn shift_reduce_bcomplement_offw_nt2<const P: bool>(
    ...
    unsafe {
        ...
        let mut acc = if m7 == 15 {
            ...
            let (bv, _) = apply_b_mode::<P>(imgs, op.add(64 + offw_krow_words::<P>(7)), m7, av);
            _mm512_gf2p8mul_epi8(av, bv)
        } else {
            let (bv, correction) =
                apply_b_mode::<P>(imgs, op.add(64 + offw_krow_words::<P>(7)), m7, av);
...
pub(crate) unsafe fn shift_reduce_bcomplement_offw_nt2_const<const BLK: usize, const P: bool>(
    ...
    unsafe {
        ...
        let mut acc = if M7 == 15 {
            ...
            let (bv, _) = apply_b_mode_const::<M7, P>(
                imgs,
        ...
        macro_rules! step {
            ($k:expr, $shift:expr) => {{
                ...
                if MODE == 15 {
                    ...
                    let (bv, _) = apply_b_mode_const::<MODE, P>(
                        imgs,
